...
class MCA(Spider):
	...
	self.din = din
	self.headers1 = [ 'CIN/FCRN','Company Name','Begin Date','End Date']
        self.headers2 = ['LLPIN/FLLPIN','LLP Name','Begin Date','End Date']
	...
	for info in information:
	    ...
	    cookies = {
	        'JSESSIONID':cook.get('JSESSIiONID',''),
	    }
	...
	for node in nodes:
	    ...
	    cvalues = [cin, companynm, begindt, enddate]
        ...
        for node in llp_nodes:
            ...
            lvalues = [llp, llpnm, begindt, enddt]
